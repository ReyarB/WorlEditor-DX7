...
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox pPaneles 
      ...
      Begin VB.ComboBox cCapas 
         ...
         ForeColor       =   &H80000014&
         Height          =   330
         ItemData        =   "frmMain.frx":57826
         Left            =   1080
         List            =   "frmMain.frx":57836
         TabIndex        =   1
         TabStop         =   0   'False
         Text            =   "1"
         Top             =   3120
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   0
         ItemData        =   "frmMain.frx":57846
         Left            =   120
         List            =   "frmMain.frx":57848
         Sorted          =   -1  'True
         TabIndex        =   71
         Tag             =   "-1"
         Top             =   120
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":5784A
         Left            =   840
         List            =   "frmMain.frx":5784C
         TabIndex        =   0
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   3
         ItemData        =   "frmMain.frx":5784E
         Left            =   120
         List            =   "frmMain.frx":57850
         TabIndex        =   66
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":57852
         Left            =   840
         List            =   "frmMain.frx":57854
         TabIndex        =   58
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   1
         ItemData        =   "frmMain.frx":57856
         Left            =   120
         List            =   "frmMain.frx":57858
         TabIndex        =   55
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   3210
         Index           =   4
         ItemData        =   "frmMain.frx":5785A
         Left            =   120
         List            =   "frmMain.frx":5785C
         TabIndex        =   54
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":5785E
         Left            =   840
         List            =   "frmMain.frx":57860
         TabIndex        =   77
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   2
         ItemData        =   "frmMain.frx":57862
         Left            =   120
         List            =   "frmMain.frx":57864
         TabIndex        =   79
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":57866
         Left            =   3360
         List            =   "frmMain.frx":57868
         TabIndex        =   67
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":5786A
         Left            =   3360
         List            =   "frmMain.frx":5786C
         TabIndex        =   57
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":5786E
         Left            =   3360
         List            =   "frmMain.frx":57870
         TabIndex        =   80
         Text            =   "500"
         Top             =   3120
         Visible         =   0   'False
   ...
   Begin VB.Menu mnumapa 
      ...
      Begin VB.Menu mnuSinTras 
         Caption         =   "Traslados, Bloquear y NPCs"
         Shortcut        =   ^T
      End
   End
...
Call frmcopiarmapa.Image1_Click
End Sub

Private Sub Image2_Click()
Call frmcopiarmapa.Image2_Click
End Sub

Private Sub Image3_Click()
Call frmcopiarmapa.Image3_Click
End Sub

Private Sub Image4_Click()
Call frmcopiarmapa.Image4_Click
End Sub
...
If tX < 10 Or tY < 8 Or tX > 91 Or tY > 93 Then
