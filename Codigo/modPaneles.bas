...
'*************************************************
    ...
    Select Case Numero
        ...
        Case 4 ' Copiar bordes de mapas automatico
            frmMain.Image1.Visible = Ver
            frmMain.Image2.Visible = Ver
            frmMain.Image3.Visible = Ver
            frmMain.Image4.Visible = Ver
        Case 5 ' OBJs
...
'If SupData(GrhIn).Width > 0 Then
    'frmConfigSup.MOSAICO.value = vbChecked
    'frmConfigSup.mAncho.Text = ObjData(GrhIn)
    'frmConfigSup.mLargo.Text = ObjData(GrhIn)
'Else
    frmConfigSup.MOSAICO.value = vbUnchecked
    frmConfigSup.mAncho.Text = "0"
    frmConfigSup.mLargo.Text = "0"
...
'    Else
        'Dim X As Integer, y As Integer, j As Integer, i As Integer
        'Dim Cont As Integer
        'For i = 1 To 1 'CInt(Val(frmConfigSup.mLargo))
        '    For j = 1 To 1 'CInt(Val(frmConfigSup.mAncho))
        '        DR.Left = (j - 1) * 32
        '        DR.Top = (i - 1) * 32
        '        DR.Right = j * 32
        '        DR.Bottom = i * 32
...
'    End If
frmGrafico.ShowPic.Picture = frmGrafico.ShowPic.Image
frmMain.PreviewObj = frmGrafico.ShowPic
End Sub
